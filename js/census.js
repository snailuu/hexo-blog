...
var access_token = '121.426634d777137ea14bd97bf00e6680b7.Ynz88nzaISQMTRYdktqOJ2d9wNnDOSL44vLeHG-.6SqXzA' // accessToken
var site_id = '19319026' // 网址 id
var dataUrl = 'https://tongji-baidu.snailuu.cn/api?access_token=' + access_token + '&site_id=' + site_id
...
function mapChart() {
    ...
    fetch(dataUrl + paramUrl).then(data => data.json()).then(data => {
      ...
      window.addEventListener("resize", () => { 
        ...
        document.getElementById('map-chart').after(scriptt);
    }).catch(function(error) {
        console.log("this is a error", error);
    });
    console.log("this is a 877777");
...
if (document.getElementById('map-chart') !== null) {
    console.log("这位是317行的");
    mapChart()
}
if (document.getElementById('trends-chart') !== null) {
    console.log("这位是321行的");

    trendsChart()
}
if (document.getElementById('sources-chart') !== null) {
    console.log("这位是321行的");
