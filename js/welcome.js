...
$.ajax({
    ...
    data: {
        key: '2RDBZ-TAG6G-7GFQB-QPJND-BQ723-4VBQG',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.390388, 22.527156, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
